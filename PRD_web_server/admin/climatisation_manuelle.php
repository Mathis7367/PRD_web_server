            ...
            <section>
                <article>
                    <p>	
						...
						<form align=center name="Mode" method="POST" action="admin_publisher.php">

						<table border=1 align = center><tr><th>Etat actuel :</th><th><?php echo $_GET['btnval'] ?></th></tr><align center>
						<tr><th> Mode </th><th> Manuel </th></tr></table><br>					
						<input type="submit" name="btn" value="OFF" />
						<input type="submit"  name="btn" value="Chauffage" />
						<input type="submit"  name="btn" value="Climatisation" /></form>				
                </article>           
            </section>
