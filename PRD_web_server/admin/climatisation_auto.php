            ...
            <section>
				...
				$mysqli = new mysqli("localhost", "root", "", "users");
						...
						while(($row = mysqli_fetch_assoc($resultat)) && $i<=0) {
							...
							echo "<table border=1 align = center><tr><th>Etat actuel :</th><th>$clim </th></tr><align center>";

					
						$i = $i+1;
						}
						echo "<tr><th> Mode </th><th> Automatique </th></tr></table>"
						
				?>
				
						<?php echo "Mode de fonctionnement : " ?>
						<form name="connexion" method="POST" action="climatisation_auto.php">
						<input type="submit" name="auto" value="Automatique"></form>
						<form name="connexion" method="POST" action="climatisation_manuelle.php?btnval=<?php echo "$clim" ?>">
						<input type="submit" name="Manuel" value="Manuel"></form>
					</p>
                </article>           
            </section>
