            ...
            <section>
                <article>
					...
					<nav>
						...
						$requete = "SELECT * FROM attempt ORDER BY nb DESC";
						$resultat = $mysqli -> query($requete);
						echo "<table border=1 align = center><tr><th>Nom d'utilisateur </th><th>Mot de passe </th><th>Tentative le :  </th></tr><align center>";
						while ($ligne = $resultat -> fetch_assoc()) {
							echo "<tr><th>$ligne[username] </th><th>$ligne[password] </th><th>$ligne[tried_at] </th></tr><align center>";
